...
#### Contacts
- Jonathan Beam (MDI Program Coordinator)
...
Work by this group produced a [book](https://www.brookings.edu/book/words-that-matter/) on the media environment in the 2016 election and was the basis for events with [Georgetown's Institute of Politics and Public Service](https://politics.georgetown.edu/).
...
We have developed four portals to date: election 2020, covid-19, and parenting. These portals are controlled by research teams, but allow for construction of variables from social media and newspaper data through easy to use forms.

MDI is partnering with Edunomics to provide school-level finance data for the entire United States.
...
[Edunomics](https://edunomicslab.org/) is a McCourt School research center focused on educational finance.  They have received substantial grant support to provide school-level educational data that will be of interest to policy-makers, educators, parents and others.

MDI is working with Edunomics to create data portals that will enable interested parties to access curated and customizable data sets on school finances.

#### Contacts
- Lisa Singh (MDI Research Professor)
- Laura Anderson (Associate Director, Edunomics)
]
---
...
.pull-left[
.center[<img src="Figures/monthlyImportRefusalByCountryBar.png"; style="max-width:550px;float:center;">]
...
#### Contacts
- Jonathan Beam (MDI Project Coordinator)
- Michael Bailey (MDI Director)
]